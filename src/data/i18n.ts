...
const projectTranslations: Record<string, Partial<Record<Language, Partial<Project>>>> = {
  "suk-sabai-home": {
    th: {
      ...
      year: "2025",
      scope: "งานออกแบบสถาปัตยกรรมและภายในขั้น schematic design",
      area: "ไซต์ W12 x L14 ม.",
      shortDescription:
        "แนวคิดบ้าน courtyard residence ที่ยังไม่ได้ก่อสร้าง ออกแบบจากความสูง แสงธรรมชาติ วัสดุที่นุ่มนวล จังหวะชีวิตครอบครัว และความสงบในชีวิตประจำวัน",
      concept:
        "บ้านบนพื้นที่แคบที่ถูกเปลี่ยนให้เป็น retreat ของครอบครัว ผ่านความสูง จังหวะ แสงธรรมชาติที่ถูกกรอง และ threshold ของสวนส่วนตัว",
      overview:
        "Suk Sabai Home เป็นงานศึกษาแนวคิดสถาปัตยกรรมและภายในสำหรับบ้านพักอาศัยส่วนตัวในขั้น concept โดยวางไซต์ขนาด 12 x 14 เมตรให้เป็นลำดับประสบการณ์ของการมาถึง สวนพักสายตา living room ที่โปร่งสูง พื้นที่เรียนรู้ของเด็ก พื้นที่พักผ่อนส่วนตัว และ ritual ของห้องน้ำ ผ่าน quiet luxury ที่เกิดจากสัดส่วนและความยับยั้งชั่งใจ ไม่ใช่การตกแต่งที่มากเกินไป",
      siteContext:
        "ข้อมูลจากแบบต้นทางระบุไซต์หน้า 12 เมตร ลึก 14 เมตร และเชื่อมต่อกับบ้านหลัก การวางผังประกอบด้วย foyer, shoes storage, terrace, private garden, living room, pantry, kid home work area, bedroom foyer, walk-in closet, bathroom และ master bathroom",
      spatialSequence:
        "ประสบการณ์เริ่มจากผนังภายนอกที่สงบและต้นไม้ใน courtyard จากนั้นค่อย ๆ เปลี่ยนจากภายนอกเข้าสู่ภายใน เปิดออกสู่ living room ที่สูงโปร่ง แล้วไหลต่อไปยังพื้นที่ที่เป็นส่วนตัวขึ้น ทั้งมุมเรียน ห้องพักผ่อน พื้นที่อาบน้ำ storage และกิจวัตรประจำวันภายใต้แสงอบอุ่น",
      brandPromise:
        "บ้านพักอาศัยที่ควรถูกจดจำจากความสงบ แสงธรรมชาติ ความสบายของครอบครัว และความหรูหราอย่างนุ่มนวลในชีวิตประจำวัน",
      spatialMetaphor:
        "ภาชนะของ courtyard ที่เงียบสงบ ซึ่งใช้แสง ความสูง และวัสดุอบอุ่น เปลี่ยนกิจวัตรธรรมดาให้กลายเป็น ritual เล็ก ๆ ของการพักใจ",
      experienceSequence: [
        "เข้าถึงผ่าน facade ส่วนตัวที่เรียบสงบ",
        "ผ่าน threshold ของต้นไม้ใน courtyard และแสงอุ่นภายนอก",
        "เปิดออกสู่ living room สูงโปร่งและ pantry edge",
        "หยุดพักที่ kid home work area และ window seat ของครอบครัว",
        "ถอยเข้าสู่ master bedroom และลำดับพื้นที่อาบน้ำ",
        "เหลือความทรงจำของความนิ่ง โทนสีอ่อน และความสงบในชีวิตประจำวัน",
      ],
      memoryMoments: [
        "courtyard arrival ที่ต้นไม้ต้นเดียวทำหน้าที่เป็นจุดเปลี่ยนจากภายนอกสู่ภายใน",
        "living room สูงโปร่งที่ใช้ความนิ่ง แสง และวัสดุนุ่มนวลสร้างชีวิตครอบครัว",
        "ritual ของห้องน้ำที่หิน แสง pendant และวิวธรรมชาติสร้างความสงบในการฟื้นคืนพลัง",
      ],
      materialLogic:
        "ปูนฉาบโทนอุ่น ไม้สีอ่อน upholstery นุ่ม ผิวหินสีอ่อน แสงโทน bronze ผ้าม่านโปร่ง built-in storage และ wall panel โทน muted สร้างภาษาของบ้านที่สัมผัสได้ ดูแลง่าย และประณีตอย่างเงียบสงบบนพื้นที่กะทัดรัด",
      businessLogic:
        "แม้เป็นงานบ้านพักอาศัยส่วนตัวในขั้นแนวคิด โปรเจกต์นี้แสดงให้เห็นว่า Aramphabot Studio สามารถแปลงพื้นที่จำกัด จังหวะชีวิตครอบครัว ความต้องการ storage และความสบายในชีวิตประจำวัน ให้กลายเป็นสภาพแวดล้อมที่มีมูลค่าทางการรับรู้สูงตั้งแต่ก่อนเริ่มก่อสร้าง",
      designNarrative: [
        "โปรเจกต์เริ่มจาก footprint ที่กะทัดรัด ไม่ใช่ไซต์ขนาดใหญ่ แนวคิดจึงไม่ได้มองความแคบเป็นข้อจำกัด แต่ใช้ความสูง ช่องเปิด built-in storage และต้นไม้ใน courtyard เพื่อทำให้บ้านรู้สึกเป็นระเบียบ โปร่ง และชัดเจนทางอารมณ์",
        "living room ถูกพัฒนาเป็น memory point หลักของบ้าน: ห้องสูงโปร่งที่มีแสงธรรมชาติ โซฟายาว โต๊ะหินเตี้ย ชั้นวางของอบอุ่น ฉาก pantry และเส้นโค้งของ volume ด้านบนที่ช่วยให้พื้นที่แคบมีความรู้สึกปล่อยวาง",
        "พื้นที่ส่วนตัวใช้ภาษาความนิ่งเดียวกัน kid home work area รวม storage โต๊ะทำงาน window seat และแสงธรรมชาติให้กลายเป็นมุมเรียนที่สงบ ส่วน master bedroom และ bathroom ใช้โทนอ่อน รายละเอียดโค้ง แสง pendant และผิวหินเพื่อสร้างการพักผ่อนโดยไม่ต้องอาศัยความหวือหวา",
      ],
      keyDesignMoves: [
        "courtyard arrival พร้อมต้นไม้หนึ่งต้นเป็น marker ของ threshold",
        "living room สูงโปร่งเพื่อขยายความรู้สึกของพื้นที่แคบ",
        "built-in storage สำหรับรองเท้า หนังสือ ของเล่น wardrobe และกิจวัตรครอบครัว",
        "ความต่อเนื่องของวัสดุอ่อนนุ่มระหว่าง living, study, bedroom และ bathroom",
        "ใช้แสงซ่อนและแสงธรรมชาติเป็นตัวสร้างบรรยากาศหลัก",
        "การนำเสนอแบบ editorial เพื่อให้ mood ของโปรเจกต์ชัดเจนก่อนการก่อสร้าง",
      ],
      materialAtmosphere:
        "บรรยากาศของโครงการอบอุ่น นุ่ม และสัมผัสได้: ผิวคล้าย limestone ปูนฉาบเนียน ไม้สีอ่อน upholstery คล้าย linen แสงซ่อนโทนอุ่น ผ้าม่านโปร่ง และเคาน์เตอร์โทนหิน ทำให้ quiet luxury เกิดจากความยับยั้ง พื้นผิว และแสง",
      clientValue:
        "สำหรับเจ้าของบ้าน แนวคิดนี้ช่วยให้เห็นว่าบ้านสามารถรู้สึกกว้างขึ้น สงบขึ้น และเป็นส่วนตัวมากขึ้น โดยไม่ต้องพึ่งการตกแต่งที่มากเกินไป งานออกแบบแปลความต้องการของครอบครัวให้กลายเป็น storage, study, rest และ ritual spaces ที่เข้าใจง่ายก่อนเริ่มก่อสร้าง",
      editorialClosing:
        "Suk Sabai Home แสดงให้เห็นว่างานบ้านพักอาศัยที่ยังไม่ได้สร้างก็สามารถมี spatial story ที่สมบูรณ์ได้ ตั้งแต่การมาถึง แสง จังหวะครอบครัว พื้นที่พักผ่อนส่วนตัว ไปจนถึงความนิ่งของชีวิตประจำวัน",
      materials: [
        "ปูนฉาบโทนอุ่น",
        "ไม้สีอ่อน",
        "ผิวหินสีอ่อน",
        "ผ้านุ่มและ upholstery",
        "ผ้าม่านโปร่ง",
        "ไฟโทน bronze",
        "built-in cabinetry",
        "wall panel โทน muted",
      ],
    },
  },
  "luca-beach-club-sichon": {
    th: {
      ...
      location: "สิชล นครศรีธรรมราช ประเทศไทย",
      year: "รอยืนยัน",
      scope: "สถาปัตยกรรม ภายใน และประสบการณ์เชิงพื้นที่",
      area: "รอยืนยัน",
      shortDescription:
        "ร้านอาหารและบีชคลับริมทะเลที่สร้างเสร็จแล้ว ออกแบบจากร่มเงา ลม ผ้าขาวที่พลิ้วไหว งานช่างเขตร้อน และความทรงจำของชายหาดสิชล",
      concept:
        "พื้นที่ hospitality ริมทะเลที่ให้ลม แสงที่ถูกกรอง การเคลื่อนไหวของผ้า งานไม้ และบรรยากาศทะเล กลายเป็นสถาปัตยกรรมของการมาถึงและการใช้เวลา",
      overview:
        "Luca Beach Club Sichon ถูกออกแบบเป็นพื้นที่ hospitality ริมชายหาดที่พาผู้คนเคลื่อนจากการมาถึง สู่ร่มเงา การรับประทานอาหาร การพักผ่อน และกิจกรรมกลางแจ้งริมทะเล โครงการตอบรับเสน่ห์ของหาดสิชล ทั้งหาดทรายสีทอง น้ำทะเลสีคราม ถนนเลียบชายฝั่ง และความตั้งใจที่จะทำให้ผู้คนสัมผัสพื้นที่ริมทะเลมากขึ้น",
      siteContext:
        "ไซต์ตั้งอยู่ในภูมิทัศน์ชายฝั่งสิชล จังหวัดนครศรีธรรมราช โดยมีแสงแดด ลมทะเล ทราย ต้นปาล์ม และวิวทะเลเป็นบริบทหลัก งานออกแบบจึงใช้เงื่อนไขเหล่านี้เป็นวัตถุดิบของสเปซ ไม่ใช่เพียงฉากหลังของอาคาร",
      spatialSequence:
        "ผู้ใช้งานเคลื่อนจากบริบทริมทะเลเข้าสู่อาคารร้านอาหารที่มีร่มเงา ก่อนค่อย ๆ เปิดออกสู่เทอเรซ ที่นั่งริมชายหาด เด็กก์กลางแจ้ง และมุมมองที่ทำให้ขอบเขตระหว่างอาคาร ภูมิทัศน์ และทะเลนุ่มลง",
      brandPromise:
        "บีชคลับที่ควรถูกจดจำจากความสบายแบบเขตร้อน บรรยากาศที่รับรู้ได้ด้วยประสาทสัมผัส รายละเอียดงานช่าง และความรู้สึกที่พาผู้คนเข้าใกล้ทะเลมากขึ้น",
      spatialMetaphor:
        "หลังคาและผ้ากรองแสงที่ตอบสนองต่อลม เสมือนระนาบคลื่นที่กรองแสงให้ระยิบเหมือนแสงใต้ผิวน้ำ",
      experienceSequence: [
        "Approach ผ่านภูมิทัศน์ชายฝั่งสิชล",
        "Threshold ใต้หลังคาโค้งและผ้าขาวที่เคลื่อนไหวตามลม",
        "Release สู่พื้นที่รับประทานอาหาร เลานจ์ และวิวทะเล",
        "Pause ในมุม beach bed เด็กก์ บาร์ และร่มเงาจากปาล์ม",
        "Afterglow ผ่านความทรงจำของลม ผ้า ไม้อบอุ่น และทะเล",
      ],
      memoryMoments: [
        "ผ้าขาวใต้หลังคาที่เคลื่อนไหวตามลมทะเล",
        "แสงที่ลอดผ่านผ้าและเกิดเงาระยิบในพื้นที่นั่ง",
        "การเปลี่ยนจากร้านอาหารใต้ร่มเงาไปสู่เด็กก์ริมชายหาด",
      ],
      materialLogic:
        "พื้นและผนังสีขาว ไม้จริง โคมไฟจักสาน วัสดุธรรมชาติ ผ้าขาวปล่อยชาย เฟอร์นิเจอร์เขตร้อน และลวดลายเพ้นท์บนเสาไม้ ช่วยสร้างบรรยากาศริมทะเลที่เบา สบาย และช่วยกรองแสงแดดจัด",
      businessLogic:
        "งานออกแบบเปลี่ยนพื้นที่ริมทะเลให้กลายเป็น destination ที่จดจำได้ รองรับการ check-in การใช้เวลานานขึ้นของลูกค้า การถ่ายภาพ การใช้งานกลางแจ้งที่ยืดหยุ่น และตัวตนของร้านที่เชื่อมกับบริบทชายฝั่ง",
      designNarrative: [
        "แนวคิดเริ่มจากศักยภาพของชายหาดสิชล ทั้งแสงแดด ลมทะเล กลิ่นของน้ำทะเล หาดทราย และความต้องการให้ผู้คนรับรู้ชายหาดด้วยร่างกาย ไม่ใช่เพียงมองเห็นจากระยะไกล",
        "หลังคาโค้งและผ้าขาวที่ปล่อยชายอิสระสร้างร่มเงาโดยยังให้แสงธรรมชาติลอดผ่าน เมื่อผ้าเคลื่อนไหวตามแรงลม แสงและเงาจะเปลี่ยนไปในแต่ละช่วงเวลา เกิดบรรยากาศคล้ายคลื่นและแสงใต้ท้องทะเล",
        "โครงการผสมฐานสถาปัตยกรรมสีขาวกับไม้จริง โคมไฟจักสาน เฟอร์นิเจอร์เขตร้อน สีคราม และกราฟิกเพ้นท์สีขาวบนเสาไม้ เพื่อให้พื้นที่มีทั้งความเรียบง่าย ความเป็นงานช่าง และภาพจำแบบ Chic and Tropical Bohemian",
      ],
      keyDesignMoves: [
        "หลังคาโค้งที่นำทางสู่ชายหาด",
        "ผ้าขาวที่ตอบสนองต่อลมทะเล",
        "แสงธรรมชาติที่ถูกกรองและร่มเงาสำหรับกิจกรรมกลางแจ้ง",
        "ลำดับร้านอาหาร เลานจ์ บาร์ เด็กก์ และที่นั่งริมชายหาด",
        "ภาษา Tropical Bohemian ผ่านวัสดุและงานช่าง",
      ],
      materialAtmosphere:
        "บรรยากาศของโครงการเบา สัมผัสได้ และเป็นชายฝั่ง: ผ้าขาว พื้นผิวสีขาว ไม้อบอุ่น วัสดุจักสาน เฟอร์นิเจอร์หวาย โทนสีคราม ทราย ต้นปาล์ม และแสงทะเลถูกจัดวางเป็นพื้นที่ hospitality ที่ผ่อนคลาย",
      clientValue:
        "สำหรับผู้ประกอบการ hospitality ริมทะเล โครงการสร้างภาพจำที่ชัด รองรับกิจกรรมกลางแจ้งในแดดแรง ขยาย guest journey จากการรับประทานอาหารไปสู่การพักผ่อนริมชายหาด และสร้างประสบการณ์ที่ถ่ายถ่ายทอดได้",
      editorialClosing:
        "Luca Beach Club Sichon เปลี่ยนปรากฏการณ์ธรรมชาติให้เป็นสถาปัตยกรรม hospitality: ร่มเงา ลม แสง งานช่าง และทะเล กลายเป็นประสบการณ์ที่ผู้คนจดจำ",
      materials: [
        "ผ้าขาวกรองแสง",
        "ไม้จริง",
        "พื้นผิวสีขาว",
        "โคมไฟจักสานวัสดุธรรมชาติ",
  ...
  "soulciety-coffee-rayong": {
    th: {
      title: "Soulciety Coffee Rayong",
      location: "ซอยนครระยอง 19 ระยอง ประเทศไทย",
      year: "รอยืนยัน",
      scope: "รีโนเวตอาคารเดิม สถาปัตยกรรม ภายใน ภูมิทัศน์ และประสบการณ์แบรนด์เชิงพื้นที่",
      area: "รอยืนยัน",
      shortDescription:
        "คาเฟ่ในระยองที่ปรับอาคารเก็บของเดิมให้เป็นพื้นที่พบปะที่สนุกแต่ยังสงบ ผ่านเปลือกอาคารสีขาว ฝ้าไฟสีแดง ผนังผิวสัมผัส และจังหวะของแบรนด์ที่ออกแบบเป็นประสบการณ์",
      concept:
        "คาเฟ่ในฐานะโลกเล็ก ๆ ของการพบปะ ที่เปลือกสีขาวอันนิ่งสงบเปิดเข้าสู่ภายในสีแดง เงาสะท้อน และบรรยากาศเล่นสนุก ชวนให้ผู้คนค้นพบ Soulciety ของตัวเอง",
      overview:
        "Soulciety Coffee Rayong คือการปรับอาคารเก็บของเดิมในซอยนครระยอง 19 ให้กลายเป็นคาเฟ่สำหรับบทสนทนา พิธีกรรมเล็ก ๆ ในชีวิตประจำวัน และการแสดงตัวตน พื้นที่ตั้งอยู่ห่างจากถนนสุขุมวิทประมาณ 50 เมตร ในซอยกว้างประมาณ 3.5 เมตร จึงเปลี่ยนอาคารเดิมที่ถ่อมตัวให้เป็นจุดหมายปลายทางเชิงพาณิชย์ที่จดจำได้",
      siteContext:
        "ที่ตั้งอยู่ในย่านที่สงบของระยอง ไม่ได้วางตัวบนหน้าถนนใหญ่โดยตรง เงื่อนไขของซอยแคบ อาคารเดิม บริบทอาคารรอบข้าง และจังหวะการเข้าถึงที่เงียบกว่า ทำให้แนวทางออกแบบเลือกให้อาคารภายนอกนิ่งและเรียบ ขณะที่ภายในรับบทเป็นพื้นที่ที่มีพลังทางอารมณ์ของแบรนด์มากขึ้น",
      spatialSequence:
        "ผู้มาเยือนเคลื่อนจากซอยเล็กและอาคารสีขาวทรงเรขาคณิต เข้าสู่ธรณีทางเข้าที่มีฝ้าสะท้อน ก่อนเปิดสู่คาเฟ่ภายในที่นิยามด้วยฝ้าไฟกริดสีแดง โต๊ะยาว เคาน์เตอร์บาร์ ผนังแสดงสินค้า และมุมที่นั่งที่นุ่มขึ้น",
      brandPromise:
        "คาเฟ่ที่ควรถูกจดจำจากบทสนทนาสบาย ๆ การแสดงตัวตนอย่างสนุก และพิธีกรรมเล็ก ๆ ของการค้นหาจังหวะทางสังคมของตัวเอง",
      spatialMetaphor:
        "กล่องสีขาวที่สงบภายนอก แต่เปิดออกสู่สัญญาณสีแดงเรืองแสงภายใน เหมือนเสียงข้างในที่ถูกแปลงให้เป็นพื้นที่",
      experienceSequence: [
        "Approach ผ่านซอยเล็กในระยอง",
        "Threshold ที่เปลือกอาคารสีขาวและขอบสวน",
        "Reflection ใต้ฝ้าทางเข้าที่สะท้อนแสงและบริบท",
        "Release เข้าสู่ฝ้าไฟสีแดง เคาน์เตอร์บาร์ และพื้นที่นั่งคาเฟ่",
        "Pause ที่โต๊ะยาว ผนังแสดงสินค้า ของสะสม และข้อความกราฟิก",
        "Afterglow ผ่านความทรงจำของแสงสีแดง ผิวสัมผัสสีขาว แบรนด์ที่เล่นสนุก และบทสนทนา",
      ],
      memoryMoments: [
        "ฝ้าไฟกริดสีแดงที่สะกดตัวตนของคาเฟ่ให้กลายเป็นภาพจำ",
        "การเปลี่ยนจากภายนอกสีขาวที่ถ่อมตัวไปสู่ภายในที่สนุกและมีพลัง",
        "โต๊ะยาว เคาน์เตอร์ ผนังสินค้า และของสะสมที่ทำงานร่วมกันเป็นฉากของแบรนด์",
      ],
      materialLogic:
        "ปูนฉาบสีขาว ผนังเซรามิกผิวสัมผัส ชั้นไม้สีอ่อน เคาน์เตอร์โทน rammed-earth งานเหล็กและอะคริลิกสีแดง กระจก ฝ้าสะท้อน และเฟอร์นิเจอร์ขาวแดง ช่วยบาลานซ์ความทนทาน ความสว่าง ตัวตนที่อ่อนเยาว์ และการใช้งานคาเฟ่ในชีวิตประจำวัน",
      businessLogic:
        "งานออกแบบเปลี่ยนที่ตั้งซึ่งซ่อนตัวอยู่ในซอยให้เป็น destination ที่จำได้ง่าย สร้างอัตลักษณ์ภาพที่แข็งแรง ลำดับการใช้งานที่ชัดเจน จุดถ่ายภาพที่มีความทรงจำ พื้นที่แสดงสินค้า และที่นั่งหลากหลายสำหรับการใช้งานจริง",
      designNarrative: [
        "โครงการเริ่มจากอาคารเก็บของเดิมในซอยที่สงบของระยอง แทนที่จะลบเงื่อนไขเดิมทั้งหมด งานออกแบบใช้การ adaptive reuse เพื่อสร้างเปลือกอาคารที่สะอาด เข้าถึงง่าย และมั่นใจเมื่อมองจากถนน",
        "เมื่อเข้าสู่ภายใน บรรยากาศเปลี่ยนอย่างตั้งใจ ฝ้าทางเข้าที่สะท้อนภาพ ฝ้าไฟกริดสีแดง โต๊ะยาว เคาน์เตอร์บาร์ ผนังแสดงสินค้า และของสะสม สร้างโลกทางสังคมที่ชัดเจนสำหรับบทสนทนา การหยุดพัก และความทรงจำของแบรนด์",
        "คาเฟ่นี้บาลานซ์ความนิ่งกับความสนุก: ภายนอกสีขาวและภูมิทัศน์ที่นุ่มลงรับกับบริบทย่าน ขณะที่แสงสีแดง ผนังผิวสัมผัส ชั้นไม้ ป้ายกราฟิก และวัตถุที่คัดสรร ทำให้ภายในมีเอกลักษณ์โดยไม่ต้องพึ่งการตกแต่งที่มากเกินไป",
      ],
      keyDesignMoves: [
        "รีโนเวตอาคารเก็บของเดิมให้เป็นคาเฟ่",
        "ใช้เปลือกอาคารสีขาวที่สงบเป็นคู่ตรงข้ามกับภายในที่มีพลัง",
        "ฝ้าทางเข้าสะท้อนภาพและฝ้าไฟกริดสีแดง",
        "ลำดับโต๊ะยาว เคาน์เตอร์บาร์ ผนังแสดงสินค้า และพื้นที่นั่ง",
        "สวนทางเข้า พื้นที่กิจกรรมภายนอก และที่จอดรถ 7 ช่อง",
      ],
      materialAtmosphere:
        "บรรยากาศเคลื่อนระหว่าง minimalism ที่นิ่งกับพลังของแบรนด์ที่เล่นสนุก: พื้นผิวสีขาวประคองอาคารเดิมให้สงบ ขณะที่แสงสีแดง กริดสะท้อน ไม้อบอุ่น เคาน์เตอร์ผิวสัมผัส จังหวะผนังเซรามิก ของสะสม และข้อความกราฟิก สร้างภายในที่มีความทรงจำชัดเจน",
      clientValue:
        "สำหรับผู้ประกอบการคาเฟ่ โครงการช่วยสร้างการจดจำแบรนด์ เวลาการใช้งานของลูกค้า ความชัดเจนด้าน operation พื้นที่ display จุดถ่ายภาพ และการเปลี่ยนที่ตั้งธรรมดาในซอยให้เป็นสถานที่ที่คนจำและกลับมาได้",
      editorialClosing:
        "Soulciety Coffee Rayong แสดงให้เห็นว่า adaptive reuse เรื่องเล่าของแบรนด์ และจังหวะของวัสดุ สามารถเปลี่ยนคาเฟ่ขนาดเล็กให้เป็นโลกทางสังคมที่จดจำได้",
      materials: [
        "ปูนฉาบสีขาวภายนอก",
        "ฝ้ากระเบื้องสะท้อน",
        "ฝ้าไฟกริดสีแดง",
        "เคาน์เตอร์ผิวโทน rammed-earth",
        "ผนังเซรามิกผิวสัมผัส",
        "ชั้นไม้สีอ่อน",
        "เฟอร์นิเจอร์ขาวแดงแบบมินิมอล",
        "กระจกหน้าร้าน",
      ],
    },
  },
